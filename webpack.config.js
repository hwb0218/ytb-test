...
(statc: 정적 파일 서빙 경로 설정, compress: gzip 압축 설정, 빌드 결과물을 브라우저에게 전달하기 전에 gzip으로 압축하여 네트워크 전송 시간을 줄여 개발자의 개발 경험을 향상시키는데 도움, port: 개발 서버를 구동할 port를 설정)
...
(clean-webpack-plugin: 이전 빌드 결과물이 남아있을 경우 제거, HtmlWebpackPlugin: html 파일을 생성하여 번들링된 자바스크립트 파일을 바인딩)
*/
module.exports = {
  entry: {
    main: './src/index.tsx'
